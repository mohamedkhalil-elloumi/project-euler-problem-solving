...
public class NthPrime {
	// we will use the method of Sieve of Eratosthenes

	/*
	 * It consists of Finding the prime numbers up to MAX_SIZE using Sieve of
	 * Eratosthenes. Store all primes in a vector and For a given number N, return
	 * the element at (N-1)th index in a vector.
	 */
